...
class db extends PDO {
    ...
    public function __construct($dsn = "", $user = "", $passwd = "") {
        ...
        $config = parse_ini_file("/var/lib/astpp/astpp-cdr-config.conf");
...
//            parent::__construct("mysql:host=".$config['dbhost'].";dbname=".$config['dbname']."", $config['dbuser'], $config['dbpass'], $options);
	    parent::__construct("pgsql:host=".$config['dbhost'].";port=".$config['dbport'].";dbname=".$config['dbname']."",$config['dbuser'], $config['dbpass']);
